...
const AssistantRole = () => {
  ...
  const { updateAgentRoles, agentId, isLoading,clearAgent } = useAgentStore();
  ...
  const handleCreate = async () => {
    ...
    const firstMessage = `Hello! Welcome to our ${specialty?.title ?? assistantName}, how can I assist you today?`;
    ...
    try {
      await updateAgentRoles(agentId, {
      ...
      <div className="flex-1 flex flex-col items-center pt-14 px-4">
        ...
        <div className="w-full max-w-225">
          ...
          <div className="bg-[#F5F3FF] rounded-full py-4 px-12 mt-8 flex items-center gap-3 mb-8">
            ...
            <p className="text-[#220068] text-[14px] font-medium tracking-tight">
          ...
          <div className="relative bg-white rounded-[25px] w-full max-w-152.5 mx-4 px-20 py-14 flex flex-col items-center text-center">
            ...
            <div className="relative mb-6">
              <svg width="148" height="97" viewBox="0 0 148 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M62.4141 53L73.4141 63L93.4141 42" stroke="white" strokeWidth="2"/>
            ...
            <div className="flex items-center gap-2 mb-10">
              <span className="text-[#1F2937] text-[14px] font-bold mt-2 tracking-wide">
                {PHONE_NUMBER}
              </span>
              <button
