        ...
        <div className="mt-30 w-full max-w-200 mx-auto">
          ...
          <div className="setup-general-input-box">
            ...
            <div className="setup-button-wrap">
              <Button
                label={isLoading ? (Icons.SpinningIcon) : "Create Account"}
                variant="primary"
            ...
            <div className="terms-of-service-box">
              <p className="terms-of-service-text">
                ...
                <span className="terms-of-service-inner-text">Terms of Service </span>
                and{" "}
                <span className="terms-of-service-inner-text">Privacy Policy</span>
              </p>
            </div>
          </div>
        </div>
